...
class App extends Component {
  ...
  statusChange = () => {
    ...
    if (timeInSecond !== 0) {
      this.setState(prevState => ({timeInSecond: prevState.timeInSecond - 1}))
    } else {
  ...
  render() {
    const {timeInSecond, imgUrl, category, isTrue, score} = this.state
                ...
                <ul>
                  ...
                  <li className="time-container">
                    <img
                      ...
                      alt="timer"
                    />
                    <p className="time-counting">{timeInSecond} sec</p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {!isTrue && (
            <div className="bottom-container">
              <div className="thumbnail-container">
                <img className="thumbnail" src={imgUrl} alt="match" />
              </div>
              <div>
